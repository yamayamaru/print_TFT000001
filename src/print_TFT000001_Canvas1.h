...
#ifndef _PRINT_TFT000001_Canvas1_H
#define _PRINT_TFT000001_Canvas1_H
...
#define _PRINT_TFT000001_Canvas1_STR_BUFF01_LEN01 2047
#ifndef _PRINT_TFT000001_Canvas1_MAX_TEXT_SIZE01
#define _PRINT_TFT000001_Canvas1_MAX_TEXT_SIZE01  2047
#endif

#include "font_class.h"

class print_TFT000001_Canvas1 : public yama_2_GFX_H_beta_Canvas1{
struct colormap {
    uint32_t fg;
    uint32_t bg;
};
...
protected:
    ...
    char str_buff01[_PRINT_TFT000001_Canvas1_STR_BUFF01_LEN01 + 1];

public:

    print_TFT000001_Canvas1(int16_t w, int16_t h);
...
#endif // _PRINT_TFT000001_Canvas1_H