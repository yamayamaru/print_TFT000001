...
print_TFT000001_Canvas1 canvas01 = print_TFT000001_Canvas1(CANVAS_WIDTH, CANVAS_HEIGHT);
    // print_TFT000001_Canvas1はメモリ上の確保したフレームバッファ上に描画するクラスです。
    // print_TFT000001_Canvas1でメモリ上に書き込んだうえで
    // print_TFT000001もしくはTFT000001のdrawBitmap()で
    // 実際にILI9341またはILI9486のLCDにフレームバッファのメモリの内容を
    // 一度に書き込むことで高速に描画ができます。
    // print_TFT000001_Canvas1を使う場合はCMakeLists.txtのadd_executableに
    // print_TFT000001_Canvas1.cppを追加するのを忘れないようにしてください
...
void random_circle(void) {
    ...
    tft.drawBitmap((TFT000001_TFT_WIDTH - CANVAS_WIDTH) / 2, (TFT000001_TFT_HEIGHT - CANVAS_HEIGHT) / 2, canvas01.getBuffer(), CANVAS_WIDTH, CANVAS_HEIGHT, TFT000001_24BIT_COLOR_CYAN, TFT000001_24BIT_COLOR_BLACK); 
    sleep_ms(10);
}
