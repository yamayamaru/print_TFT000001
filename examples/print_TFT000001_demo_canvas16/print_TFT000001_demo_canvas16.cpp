...
int main() {
  ...
  tft.set_rotation(0);
  tft.fillScreen(TFT000001_16BIT_COLOR_BLACK);
...
print_TFT000001_Canvas16 canvas01 = print_TFT000001_Canvas16(CANVAS_WIDTH, CANVAS_HEIGHT);
    // print_TFT000001_Canvas16はメモリ上の確保したフレームバッファ上に描画するクラスです。
    // print_TFT000001_Canvas16でメモリ上に書き込んだうえで
    // print_TFT000001もしくはTFT000001のdrawRGBBitmap16()で
    // 実際にILI9341またはILI9486のLCDにフレームバッファのメモリの内容を
    // 一度に書き込むことで高速に描画ができます。
    // print_TFT000001_Canvas16を使う場合はCMakeLists.txtのadd_executableに
    // print_TFT000001_Canvas16.cppを追加するのを忘れないようにしてください
...
void loop02_setup(void) {
    ...
    canvas01.set_font_color(TFT000001_16BIT_COLOR_MAGENTA, TFT000001_16BIT_COLOR_BLACK);
...
void random_circle(void) {
    ...
    tft.drawRGBBitmap16((TFT000001_TFT_WIDTH - CANVAS_WIDTH) / 2, (TFT000001_TFT_HEIGHT - CANVAS_HEIGHT) / 2, canvas01.getBuffer(), CANVAS_WIDTH, CANVAS_HEIGHT); 
    sleep_ms(10);
}
